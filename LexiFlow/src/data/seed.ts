...
export const faqItems: FaqItem[] = [
  { id: "faq1", category: "account", question: "FSRS-4.5 记忆间隔算法是如何工作的？", answer: "语脉采用现代自由间隔复习算法（FSRS-4.5），相比传统艾宾浩斯固定曲线，它会根据单词的记忆稳定性（S）与难度（D）动态推算最佳复习时点，平均减少 30% 重复做功，抗遗忘保持率可达 90% 以上。" },
  { id: "faq2", category: "payments", question: "如何导入 YouTube 或 B 站视频进行精听？", answer: "进入「视频精听」页面，在顶部输入框直接粘贴在线视频 URL，系统将自动拉取音视频源，并调用离线 Whisper 模型生成词级强制对齐字幕与声学波形切片。" },
  { id: "faq3", category: "security", question: "影子跟读（Shadowing）的声学评分标准是什么？", answer: "系统对比您朗读录音与原声母语者的声学共振峰特征，从音准准确度、流利连贯性、语调起伏三个维度进行综合评定，并给出音素级别的颜色反馈与发音建议。" },
  { id: "faq4", category: "billing", question: "词书与大纲词库如何自由切换？", answer: "进入「词书库」页面，可选择 CET-6 核心词、考研必考 5500 词、专八或 COCA 20,000 高频词。点击卡片上的「设为主词书」，今日研习队列将自动无缝重排。" },
  { id: "faq5", category: "account", question: "在阅读长文时生词是如何自动沉淀的？", answer: "在「阅读库」中阅读外刊或学术长文时，选中生词即可触发秒级浮窗查词，点击「采摘到生词本」后，生词将携带原句语境上下文与例句自动注入 FSRS 今日复习队列。" },
  { id: "faq6", category: "security", question: "我的研习记录和个人生词本存储在本地吗？", answer: "是的，语脉采用离线优先（Local-First）架构，所有生词本、复习状态、音频切片与热力图记录均存储在您本地的 SQLite/DuckDB 数据库中，100% 保护隐私与离线可用性。" },
  { id: "faq7", category: "payments", question: "什么是「语境串词生文（Story Mode）」？", answer: "该功能利用轻量大模型，基于您今日到期复习的 15~20 个生词，严格限定大纲背景难度，量身生成一篇情节生动的小短文，让您在连贯故事中自然复习，强化情境记忆。" },
  { id: "faq8", category: "general", question: "如何调整每日研习的新词与复习通量？", answer: "在首页任务看板或系统设置中，可自由调整每日目标新词量（默认 20 词）。FSRS 算法引擎将根据历史遗忘回流情况自动为您规划合理的复习量，避免认知过载。" },
  { id: "faq9", category: "billing", question: "遇到不熟悉的专业学科词汇怎么办？", answer: "语脉内置离线 ECDICT 百万级词典，并支持医学、计算机、天文等 14 类学术学科标签，划词即可获取权威中英双解、词根派生与音标发音。" },
  { id: "faq10", category: "general", question: "如何将本地生词本导出为 Anki 卡包？", answer: "在生词本页面点击右上角「导出」，选择「Anki 格式 (.apkg)」或「CSV 数据表」，即可一键将带有原声切片和上下文例句的卡片导出到其他学习工具中使用。" },
]
...
export const supportTickets: SupportTicket[] = [
  { id: "tk1", subject: "Whisper 词级强制对齐延迟与长音频优化建议", status: "in-progress", priority: "high", createdAt: "2026-09-08", lastUpdate: "2026-09-11" },
  { id: "tk2", subject: "请求新增计算机学术论文外刊分级语料库", status: "open", priority: "medium", createdAt: "2026-09-09", lastUpdate: "2026-09-10" },
  { id: "tk3", subject: "离线本地 SQLite 词典缓存重建反馈", status: "resolved", priority: "low", createdAt: "2026-09-02", lastUpdate: "2026-09-05" },
]

export const systemStatus = [
  { name: "FSRS 记忆调度引擎 (Core Algorithm)", status: "operational" as const },
  { name: "Whisper 原声词级对齐服务 (ASR)", status: "operational" as const },
